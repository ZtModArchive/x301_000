...
dword specularMaterialSource	: SpecularMaterialSource =	COLOR2;	// D3DMATERIALCOLORSOURCE
...
dword alphaOp0			: AlphaOp0 =		SELECTARG1;
...
dword vertexBlend				: VertexBlend = 0;
dword indexedVertexBlendEnable	: IndexedVertexBlendEnable = false;
...
//dword magFilter0		: MagFilter0 = POINT;
//dword magFilter1		: MagFilter1 = POINT;
//dword magFilter2		: MagFilter2 = POINT;
//dword magFilter3		: MagFilter3 = POINT;
...
//dword mipFilter1		: MipFilter1 = NONE;
...
technique TBasic
{
    pass P0
    {
		...
		// Setting vertex blend states back to defaults
		VertexBlend = (vertexBlend);
		IndexedVertexBlendEnable = (indexedVertexBlendEnable);		
		...
		TextureTransform[2] = (textureTransform2);
		TextureTransform[3] = (textureTransform3);
